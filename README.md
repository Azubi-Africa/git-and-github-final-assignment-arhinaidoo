...
|:--:|:--------------:|:--------------:|:--------------:|
| 1 | python_caesar_cipher| a caesar cipher encryting | https://  https://github.com/arhinaidoo/python-caesars-cipher.git     |
| 2 | sales_stock_level_planner | an inventory planner | https:// https://github.com/arhinaidoo/sales-stock-level-planner.git      |
| 3 | powerBI_visualization | used power BI to visualize a set of data | https:// https://github.com/arhinaidoo/powerBI_visualization.git      |
